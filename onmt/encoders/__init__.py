...
from onmt.encoders.transformer import TransformerEncoder, TransformerFlatEncoder
...
str2enc = {"ggnn": GGNNEncoder, "rnn": RNNEncoder, "brnn": RNNEncoder,
           ...
           "transformer_flat": TransformerFlatEncoder,
           "img": ImageEncoder, "audio": AudioEncoder, "mean": MeanEncoder}

__all__ = ["EncoderBase", "TransformerEncoder", "RNNEncoder", "CNNEncoder",
           "MeanEncoder", "str2enc", "TransformerFlatEncoder"]
